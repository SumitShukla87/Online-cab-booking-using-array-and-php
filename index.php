...
<?php
    $location=array("Charbagh"=>"0",
                    ...
                    "Gorakhpur"=>"210");
?>
<section class="container-fluid text-white" id="booking-details">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 text-center bg-form border border-warning rounded">
            <form action="" method="POST">
                <div class="form-group col-sm-12">
                    <p class="rounded-pill text-dark city-taxi-p">
                ...
                <div class="form-group col-sm-12">
                    <div class="input-group mb-2">
                        ...
                        <input type="number" class="form-control" id="luggage" name="weight" placeholder="Enter Luggage Here In Kg">
                    </div>
                </div>
                <div class="form-group col-sm-12">
                    <input type="submit" class="btn btn-lg calc-btn text-warning rounded-pill" Value="Calculate Fare" name="submit">
                </div>
            </form>
        </div>
    </div>
